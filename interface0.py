...
def main(cfg: DictConfig):
    ...
    styles = [
        ...
        # 💕 РОМАНТИЧНЫЕ И НЕЖНЫЕ
        {
            ...
            "prompt": f"a romantic sks budgerigar, heart shapes, red and pink, love, valentine style, tender, soft lighting, two budgies kissing, {ANATOMY_BOOST}, {COMPOSITION_FULL}, {UNIVERSAL_POSITIVE}",
            "negative": NEGATIVE_BOOST + ", aggressive, scary, dark, sad, alone"
        },
        {
            "name": "Облако влюбленных",
            "prompt": f"two sks budgerigars together, soft pink clouds, romantic, couple, adorable, affectionate, lovebirds style, cuddling, {ANATOMY_BOOST}, {COMPOSITION_FULL}, {UNIVERSAL_POSITIVE}",
            "negative": NEGATIVE_BOOST + ", alone, aggressive, scary, dark"
        },
        {
