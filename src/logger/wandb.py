...
class WandBWriter:
    ...
    def add_audio(self, audio_name, audio, sample_rate=None):
        ...
        self.wandb.log(
            {
            audio_name: self.wandb.Audio(audio, sample_rate=sample_rate)
            },
            step=self.step,
        )
    ...
    def add_text(self, text_name, text):
        ...
        """
        self.wandb.log(
            {text_name: self.wandb.Html(text)}, step=self.step
        )
    ...
    def add_histogram(self, hist_name, values_for_hist, bins=None):
        ...
        self.wandb.log({hist_name: hist}, step=self.step)
    ...
    def add_table(self, table_name, table: pd.DataFrame):
        ...
        """
        self.wandb.log(
            {table_name: self.wandb.Table(dataframe=table)},
            step=self.step,
        )
